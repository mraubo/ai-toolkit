...
- [x] 4.5 PHP colleague milestone: `.cursor/skills/code-review/` + `AGENTS.md` without composer.json — bf8981d
- [x] 4.6 Tag `v0.1.0` publish; install from published package works — bf8981d
- [x] 4.7 Uninstall after published install leaves no toolkit artifacts — bf8981d
